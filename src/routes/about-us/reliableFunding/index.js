                ...
                <div className="rf-grid">
                    <div className="text-grid-items">
                        ...
                        <div className="box-subgrid">
                            ...
                            <div className="subgrid-items animate__animated animate__fadeInUp wow" data-wow-offset="250">
                    ...
                    <div className="img-grid-items subgrid-items animate__animated animate__fadeInUp wow" data-wow-offset="50">
