        ...
        <section className="marketsOverview-section">
            <div className="container-lg">
                <div className="grid">
                    ...
                    <div
                        className="grid-items-mo-card animate__animated animate__fadeInUp wow"
                    >
                        <div className="card-body">
                            ...
                            <div className="card-content">
                                <h4>Forex</h4>
                                <p>
                                    Access major, minor, and selected exotic currency
                                    pairs with deep liquidity and competitive spreads.
                                </p>
                            </div>
                        </div>
                    </div>
            ...
            <div
                className="doller animate__animated animate__fadeIn wow"
            >
